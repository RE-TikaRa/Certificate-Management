...
class SettingsPage(BasePage):
    ...
    def __init__(self, ctx, theme_manager: ThemeManager):
        ...
        self.backup_list.setMinimumWidth(0)
        self.backup_list.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        ...
        self.ai_keys_table.setMinimumWidth(0)
        self.ai_keys_table.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        ...
        self.school_major_list.setMinimumWidth(0)
        self.school_major_list.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        self.school_major_list.setWordWrap(True)
        self.school_major_list.setTextElideMode(Qt.TextElideMode.ElideMiddle)
        ...
        self.import_log_list.setMinimumWidth(0)
        self.import_log_list.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        self.import_log_list.setWordWrap(True)
        self.import_log_list.setTextElideMode(Qt.TextElideMode.ElideMiddle)
    ...
    def _build_ui(self) -> None:
        ...
        scroll.setViewportMargins(0, 0, 24, 0)
        ...
        layout.setContentsMargins(32, 28, 48, 32)
    ...
    @staticmethod
    def _tune_form_layout(form: QFormLayout) -> None:
    ...
    @staticmethod
    def _relax_inputs(root: QWidget) -> None:
        for cls in (LineEdit, ComboBox, EditableComboBox, PlainTextEdit):
    ...
    def _build_ai_card(self) -> QWidget:
        ...
        self._tune_form_layout(top_form)
        ...
        provider_layout.addWidget(self.ai_provider, 0, 0, 2, 1)
        provider_btn_top = QHBoxLayout()
        provider_btn_top.setContentsMargins(0, 0, 0, 0)
        provider_btn_top.setSpacing(8)
        provider_btn_top.addWidget(self.ai_provider_add_btn)
        provider_btn_top.addWidget(self.ai_provider_rename_btn)
        provider_btn_top.addStretch()
        provider_btn_bottom = QHBoxLayout()
        provider_btn_bottom.setContentsMargins(0, 0, 0, 0)
        provider_btn_bottom.setSpacing(8)
        provider_btn_bottom.addWidget(self.ai_provider_delete_btn)
        provider_btn_bottom.addStretch()
        provider_layout.addLayout(provider_btn_top, 0, 1)
        provider_layout.addLayout(provider_btn_bottom, 1, 1)
        ...
        self._tune_form_layout(bottom_form)
        model_row = QWidget()
        model_layout = QGridLayout(model_row)
        model_layout.setContentsMargins(0, 0, 0, 0)
        model_layout.setHorizontalSpacing(8)
        model_layout.setVerticalSpacing(8)
        model_layout.addWidget(self.ai_model, 0, 0, 2, 1)
        model_btn_top = QHBoxLayout()
        model_btn_top.setContentsMargins(0, 0, 0, 0)
        model_btn_top.setSpacing(8)
        model_btn_top.addWidget(self.ai_pick_model_btn)
        model_btn_top.addWidget(self.ai_refresh_models_btn)
        model_btn_top.addStretch()
        model_btn_bottom = QHBoxLayout()
        model_btn_bottom.setContentsMargins(0, 0, 0, 0)
        model_btn_bottom.setSpacing(8)
        model_btn_bottom.addWidget(self.ai_test_btn)
        model_btn_bottom.addStretch()
        model_layout.addLayout(model_btn_top, 0, 1)
        model_layout.addLayout(model_btn_bottom, 1, 1)
    ...
    def _build_mcp_card(self) -> QWidget:
        ...
        mcp_row.addWidget(self._mcp_start_btn)
        mcp_row.addWidget(self._mcp_stop_btn)
        mcp_row.addWidget(self._mcp_log_btn)
        mcp_row.addStretch()
        web_row = QHBoxLayout()
        web_row.setSpacing(8)
        web_row.addWidget(self._web_start_btn)
        web_row.addWidget(self._web_stop_btn)
        web_row.addWidget(self._web_open_btn)
        web_row.addWidget(self._web_log_btn)
        web_row.addStretch()
        btn_row.addLayout(mcp_row)
        btn_row.addLayout(web_row)
    ...
    def _build_major_card(self) -> QWidget:
        ...
        import_row_top = QHBoxLayout()
        import_row_top.setSpacing(8)
        import_row_top.addWidget(self.school_import_btn)
        import_row_top.addWidget(self.major_import_btn)
        import_row_top.addStretch()
        import_row_bottom = QHBoxLayout()
        import_row_bottom.setSpacing(8)
        import_row_bottom.addWidget(self.mapping_import_btn)
        import_row_bottom.addStretch()
        btn_row.addLayout(import_row_top)
        btn_row.addLayout(import_row_bottom)
        card_layout.addLayout(btn_row)
        ...
        self.region_selector.setSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        selector_row.addWidget(self.region_selector, 0)
        selector_row.addWidget(QLabel("学校"))
        self.school_selector.setMinimumWidth(0)
        self.school_selector.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
    ...
    def _build_award_import_card(self) -> QWidget:
        ...
        import_row.addWidget(self.award_import_btn)
        import_row.addWidget(self.award_export_btn)
        import_row.addWidget(self.award_template_btn)
        ...
        option_row.addWidget(self.award_dry_run)
        option_row.addStretch()
        btn_row.addLayout(import_row)
        btn_row.addLayout(option_row)
        card_layout.addLayout(btn_row)
    ...
    def _build_cleanup_card(self) -> QWidget:
        ...
        cleanup_row.addWidget(clear_log_btn)
        cleanup_row.addWidget(clear_backup_btn)
        cleanup_row.addWidget(clear_db_btn)
        cleanup_row.addStretch()
        danger_row = QHBoxLayout()
        danger_row.setSpacing(8)
        danger_row.addWidget(clear_all_btn)
        danger_row.addStretch()
        btn_row.addLayout(cleanup_row)
        btn_row.addLayout(danger_row)
        card_layout.addLayout(btn_row)
        return card
    ...
    def _build_flags_card(self) -> QWidget:
        ...
        self.flags_container.setMinimumWidth(0)
        self.flags_container.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        ...
        self.flags_layout.setColumnMinimumWidth(0, 160)
        self.flags_layout.setColumnMinimumWidth(1, 130)
        self.flags_layout.setColumnMinimumWidth(2, 80)
        self.flags_layout.setColumnMinimumWidth(3, 60)
        self.flags_layout.setColumnMinimumWidth(4, 110)
        self.flags_layout.setColumnMinimumWidth(5, 110)
